...
[_QWERTY] = LAYOUT_6x6(
     ...
     KC_H  , KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_LBRACKET,
     KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RBRACKET,
                    KC_LEFT, KC_RIGHT,
     KC_BSPACE, KC_SPACE,
    KC_END,  KC_UP,
        LT(_LOWER,KC_HOME), KC_DOWN
  ),
  // [_QWERTY] = LAYOUT_6x6(
  ...
  // ),
   ...
   [_LOWER] = LAYOUT_6x6(
     ...
     KC_RPRN, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_PIPE,
        KC_INS, KC_P1 , KC_P2 , KC_P3 ,KC_EQL ,KC_UNDS,
     _______, KC_P0,
        KC_BSPACE, KC_SPACE,
        KC_PGUP,  KC_UP,
        LT(_QWERTY,KC_PGDN), KC_DOWN
),
